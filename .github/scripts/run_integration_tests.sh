...
if [[ -f "$TEST_CONFIG_DIR/test_assignment.conf" ]]; then
    ...
    $CLASSROOM_PILOT_CMD assignments orchestrate --config "$TEST_CONFIG_DIR/test_assignment.conf" --dry-run
else
...
if [[ -f "$TEST_CONFIG_DIR/minimal_assignment.conf" ]]; then
    ...
    $CLASSROOM_PILOT_CMD assignments orchestrate --config "$TEST_CONFIG_DIR/minimal_assignment.conf" --dry-run
else
...
if [[ -f "$TEST_CONFIG_DIR/advanced_assignment.conf" ]]; then
    ...
    $CLASSROOM_PILOT_CMD assignments orchestrate --config "$TEST_CONFIG_DIR/advanced_assignment.conf" --dry-run
else
...
if [[ -f "$TEST_CONFIG_DIR/edge_case_assignment.conf" ]]; then
    ...
    $CLASSROOM_PILOT_CMD assignments orchestrate --config "$TEST_CONFIG_DIR/edge_case_assignment.conf" --dry-run
else
